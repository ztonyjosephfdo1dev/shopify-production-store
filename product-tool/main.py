...
CATEGORY_TO_COLLECTION = {
    ...
    "bodycon": ["bodycon"], "fancy-crop-top": ["fancy-crop-top", "crop-top", "tops"],
    ...
    "jeans": ["jeans", "bottom"], "t-shirt": ["t-shirt", "tops"],
    "knitting-top": ["knitting-top", "tops"], "tan-top": ["tan-top", "tops"],
    "fancy-top": ["fancy-top", "tops"], "crop-top": ["crop-top", "fancy-crop-top", "tops"],
    "formal-pants": ["formal-pants", "bottom"], "joggers": ["joggers", "bottom"],
    "shorts": ["shorts", "bottom"], "leggings": ["leggings", "bottom"],
    "cargo-pants": ["cargo-pants", "bottom"],
    "accessories": ["accessories"], "bag": ["bag", "accessories"],
    "casual-slipper": ["casual-slipper", "accessories"],
...
GARMENT_TO_COLLECTION = {
    "crop top": ["crop-top", "fancy-crop-top", "tops"], "crop-top": ["crop-top", "fancy-crop-top", "tops"],
    "top": ["tops", "top-wear"], "t-shirt": ["t-shirt", "tops"],
    "tee": ["t-shirt", "tops"], "tank top": ["tan-top", "tops"],
    "tank-top": ["tan-top", "tops"], "camisole": ["tan-top", "tops"],
    "knit top": ["knitting-top", "tops"], "knitting top": ["knitting-top", "tops"],
    "sweater": ["knitting-top", "tops"], "cardigan": ["knitting-top", "tops"],
    "fancy top": ["fancy-top", "tops"], "party top": ["fancy-top", "tops"],
    ...
    "jeans": ["jeans", "bottom"], "baggy jeans": ["jeans", "bottom"],
    "pants": ["formal-pants", "bottom"], "trousers": ["formal-pants", "bottom"],
    "formal pants": ["formal-pants", "bottom"], "dress pants": ["formal-pants", "bottom"],
    "joggers": ["joggers", "bottom"], "track pants": ["joggers", "bottom"],
    "sweatpants": ["joggers", "bottom"],
    "shorts": ["shorts", "bottom"], "bermuda": ["shorts", "bottom"],
    "leggings": ["leggings", "bottom"], "tights": ["leggings", "bottom"],
    "culottes": ["bottom", "bottom-1"],
    "capri": ["bottom", "bottom-1"], "plazo": ["plazo", "bottom"],
    "dhoti-pants": ["bottom", "bottom-1"], "wide-leg pants": ["bottom", "bottom-1"],
    "cargo pants": ["cargo-pants", "bottom"], "cargo": ["cargo-pants", "bottom"],
    "bag": ["bag", "accessories"], "slipper": ["casual-slipper", "accessories"],
}
...
GARMENT_TYPE_TO_CATEGORY = {
    ...
    "cord-set": "coord_set", "kurti-set": "coord_set",
    "kurthi-set": "coord_set", "suits": "coord_set",
    "coord-set": "coord_set", "co-ord": "coord_set",
    "plazo-set": "coord_set", "palazzo-set": "coord_set",
    "salwar-suit": "coord_set", "sharara-set": "coord_set",
