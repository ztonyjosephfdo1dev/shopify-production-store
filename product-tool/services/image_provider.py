...
_3D_BASE = (
    ...
    "The neckline/collar opening MUST be FULLY VISIBLE and prominently show the inner collar depth — "
    "tilt the garment slightly forward so the inside of the neckline is clearly exposed, "
